...
class TestMaksukortti(unittest.TestCase):
    ...
    def testi_kortille_voi_ladata_rahaa(self):
    ...
    def test_syo_edullisesti_onnistuu_kun_saldo_sama_kuin_hinta(self):
        kortti = Maksukortti(2.5)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.0 euroa")

    def test_syo_maukkaasti_onnistuu_kun_saldo_sama_kuin_hinta(self):
